...
namespace CustomGrid_PreviewRow {
    ...
    public class CustomGridViewInfo : AdvBandedGridViewInfo {
        ...
        public virtual Rectangle GetRowPreviewEditBounds(GridDataRowInfo ri) {
            ...
            var _previewTextIndent = Painter.ElementsPainter.RowPreview.GetPreviewTextIndent(ri);
            var _previewTextVIndent = Painter.ElementsPainter.RowPreview.GetPreviewTextVIndent(ri);
        ...
        protected virtual int CalcRowPreviewEditorHeight(int rowHandle, RepositoryItem item) {
            ...
            Graphics g = GInfo.AddGraphics(null);
            int _previewTextIndent = Painter.ElementsPainter.RowPreview.GetPreviewTextIndent(EmptyDataRow);
            try {
                ...
                if (ha != null) {
                    ...
                    res = ha.CalcHeight(GInfo.Cache, this.CalcRowPreviewWidth(rowHandle) - this.PreviewIndent - _previewTextIndent * 2);
                }
